...
export function DeleteLeadButton({ leadId, leadName }: { leadId: string; leadName: string }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button variant="destructive" />}>Delete lead</DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Delete {leadName}?</DialogTitle>
          <DialogDescription>
            This soft-deletes the lead — it will be hidden from lists but can be recovered later.
          </DialogDescription>
        </DialogHeader>
